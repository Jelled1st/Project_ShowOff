...
public class BKM : MonoBehaviour
{
    ...
    [FMODUnity.EventRef]
    [SerializeField]
    private string musicMenu = "event:/BKM/Menu Music";

    [Space]
    [Header("Farm")]
    [FMODUnity.EventRef]
    [SerializeField]
    private string musicFarm = "event:/BKM/Farm Music";

    [FMODUnity.EventRef]
    [SerializeField]
    private string farmTruckDrive = "event:/SFX_TRUCK/Farm Truck Driving";

    [Space]
    [Header("Factory")]
    [FMODUnity.EventRef]
    [SerializeField]
    private string musicFactory = "event:/BKM/Factory Music";

    [FMODUnity.EventRef]
    [SerializeField]
    private string factoryHum = "event:/SFX_FACTORY/Conveyor Hum";

    [Space]
    [Header("Kitchen")]
    [FMODUnity.EventRef]
    [SerializeField]
    private string musicHome = "event:/BKM/Kitchen Music";

    [Space]
    [Header("Transit Cutscenes")]
    [FMODUnity.EventRef]
    [SerializeField]
    private string farmTruckTransit = "event:/SFX_TRUCK/Farm Truck Transit";
